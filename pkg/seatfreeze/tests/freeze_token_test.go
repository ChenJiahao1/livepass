...
func TestFreezeTokenRoundTrip(t *testing.T) {
	token := seatfreeze.FormatToken(20001, 30001, 91001)
	if token != "freeze-st20001-tc30001-o91001" {
	...
	if parsed.ShowTimeID != 20001 || parsed.TicketCategoryID != 30001 || parsed.OrderNumber != 91001 {
...
func TestParseTokenRejectsInvalidValue(t *testing.T) {
	cases := []string{
		"",
		"freeze-st0-tc30001-o91001",
		"freeze-st20001-tc0-o91001",
		"freeze-st20001-tc30001-o0",
		"freeze-st20001-tc30001-o91001",
