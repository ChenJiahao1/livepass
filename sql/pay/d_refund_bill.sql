...
CREATE TABLE `d_refund_bill` (
  ...
  `refund_bill_no` bigint NOT NULL COMMENT 'refund bill no',
  `order_number` bigint NOT NULL COMMENT 'business order number',
  ...
  `refund_reason` varchar(256) DEFAULT NULL COMMENT 'refund reason copy',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='refund bill';
