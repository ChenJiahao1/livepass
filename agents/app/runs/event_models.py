...
RUN_EVENT_TYPE_MESSAGE_COMPLETED = "message.completed"
RUN_EVENT_TYPE_MESSAGE_FAILED = "message.failed"
RUN_EVENT_TYPE_MESSAGE_CANCELLED = "message.cancelled"
RUN_EVENT_TYPE_TOOL_CALL_CREATED = "tool_call.created"
RUN_EVENT_TYPE_TOOL_CALL_UPDATED = "tool_call.updated"
RUN_EVENT_TYPE_TOOL_CALL_WAITING_HUMAN = "tool_call.waiting_human"
