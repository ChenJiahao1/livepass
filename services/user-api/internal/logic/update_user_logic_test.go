...
func TestUpdateUserCallsRpc(t *testing.T) {
	...
	logic := NewUpdateUserLogic(context.Background(), &svc.ServiceContext{UserRpc: fake})
...
func TestUpdatePasswordCallsRpc(t *testing.T) {
	...
	logic := NewUpdatePasswordLogic(context.Background(), &svc.ServiceContext{UserRpc: fake})
...
func TestUpdateEmailCallsRpc(t *testing.T) {
	...
	logic := NewUpdateEmailLogic(context.Background(), &svc.ServiceContext{UserRpc: fake})
...
func TestUpdateMobileCallsRpc(t *testing.T) {
	...
	logic := NewUpdateMobileLogic(context.Background(), &svc.ServiceContext{UserRpc: fake})
...
func TestAuthenticationCallsRpc(t *testing.T) {
	...
	logic := NewAuthenticationLogic(context.Background(), &svc.ServiceContext{UserRpc: fake})
