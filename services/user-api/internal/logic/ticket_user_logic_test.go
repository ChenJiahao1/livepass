...
func TestListTicketUsersMapsResponse(t *testing.T) {
	...
	logic := NewListTicketUsersLogic(context.Background(), &svc.ServiceContext{UserRpc: fake})
...
func TestAddTicketUserCallsRpc(t *testing.T) {
	...
	logic := NewAddTicketUserLogic(context.Background(), &svc.ServiceContext{UserRpc: fake})
...
func TestDeleteTicketUserCallsRpc(t *testing.T) {
	...
	logic := NewDeleteTicketUserLogic(context.Background(), &svc.ServiceContext{UserRpc: fake})
