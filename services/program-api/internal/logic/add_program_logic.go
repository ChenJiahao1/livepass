...
type AddProgramLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewAddProgramLogic(ctx context.Context, svcCtx *svc.ServiceContext) *AddProgramLogic {
	return &AddProgramLogic{
...
func (l *AddProgramLogic) AddProgram(req *types.ProgramAddReq) (resp *types.IdResp, err error) {
	rpcResp, err := l.svcCtx.ProgramRpc.CreateProgram(l.ctx, &programrpc.CreateProgramReq{
