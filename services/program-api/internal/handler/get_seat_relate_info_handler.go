...
func GetSeatRelateInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewGetSeatRelateInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetSeatRelateInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
